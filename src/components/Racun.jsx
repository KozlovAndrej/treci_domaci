...
export default function Racun(props) {
    ...
    return (
        <div className='container oukviren pb-2 pt-2 mt-2 mb-2' >
            <div className='row'>
                <div className='col-5'>
                ...
                <div className='col-7'>
                    <div className='row'>
                        ...
                        <div className='col-6'>
                            <label >Iznos</label>
                            <input min='100' className='form-control' onChange={(e) => {
                                const value = e.target.value;
                                setIznos(value);
            ...
            <div className='row'>
                ...
                <div className='col-7'>
                    {props.aktivan && (
                        <button className='form-control btn btn-secondary mt-5'
                            onClick={(e) => {
                                e.preventDefault();
